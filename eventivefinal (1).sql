...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2021 at 10:34 PM
...
(10, 14, '2020-02-02', '11:30'),
(11, 15, '2020-02-23', '12:30'),
(12, 16, '2020-02-25', '12:30'),
(13, 17, '2019-04-05', '05:56'),
(14, 18, '2020-02-11', '12:39'),
(15, 18, '2020-03-15', '22:05'),
(16, 19, '2020-04-09', '14:30'),
(17, 15, '2020-04-20', '09:30'),
(18, 18, '2021-03-31', '16:41');
...
(14, 'jayram ', 21, '5865754', '1', 'aarna@g.com', '8867252656'),
(15, 'keerthi', 21, '431534', '1', 'keerthi@gmail.com', '7259279585'),
(16, 'jayram ', 40, '7687162', '3', 'jack@gmail.com', '8971715217'),
(17, 'sunaina', 21, '651241', '1', 'sunaina@gmail.com', '9902837799'),
(18, 'shankar', 21, '4625', '1', 'shanakar@gmail.com', '8884233310'),
(19, 'sanjal donthi', 21, 'abc1234pt', '4', 'sanjal.donthi@gmail.com', '8867252656');
...
CREATE TABLE `event_type` (
  ...
  `tye_name` varchar(150) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `event_type` (`type_id`, `tye_name`) VALUES
(2, 'Premium'),
(3, 'Standard'),
(1, 'Luxury');
...
--
ALTER TABLE `appointment`
  MODIFY `ap_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
